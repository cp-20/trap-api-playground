export type paths = {
    ...
    "/channels/{channelId}/stats": {
        parameters: {
            query?: {
                ...
                "exclude-deleted-messages"?: components["parameters"]["excludeDeletedMessagesInQuery"];
            };
            header?: never;
            path: {
                /** @description チャンネルUUID */
    ...
    "/users/me/stamp-recommendations": {
        ...
        /**
         * スタンプレコメンドを取得
         * @description 自分のスタンプレコメンドを最大200件まで取得します。
         *     結果は推薦度の高い順で返されます。
         *     スタンプを使用したことがないユーザーの場合は空配列が返されます。
         */
        get: operations["getMyStampRecommendations"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/webhooks/{webhookId}/messages/{messageId}": {
        ...
        /**
         * Webhookの投稿メッセージを削除
         * @description 指定されたWebhookが投稿したメッセージを削除します。
         */
    ...
    "/channels/{channelId}/path": {
        ...
        /**
         * 指定したチャンネルパスを取得
         * @description 指定されたチャンネルのパスを取得します。
         */
...
export type components = {
    schemas: {
         ...
         * @enum {string}
         */
        ChannelViewState: "none" | "stale_viewing" | "monitoring" | "editing";
        /**
         * PostFileRequest
...
export interface operations {
    ...
    getFile: {
        parameters: {
            query?: {
                /**
                 * @deprecated
                 * @description このクエリパラメータは廃止されており、意味を持ちません（現在、このパラメータが0の場合も1の場合もレスポンスにはContent-Dispositionヘッダーが付与されます）
                 */
                dl?: number;
            };
            header?: never;
    ...
    addUserGroupMember: {
        ...
        requestBody?: {
            content: {
                "application/json": components["schemas"]["UserGroupMember"] | components["schemas"]["UserGroupMembers"];
            };
        };
        responses: {
            /**
