declare namespace Traq {
  ...
  export type ChannelViewState =
    "none" | "stale_viewing" | "monitoring" | "editing";
  ...
  export type OAuth2Scope =
    "openid" | "profile" | "read" | "write" | "manage_bot";
  ...
  export type ChannelEvent = {
    ...
    datetime: string;
    detail:
      | Traq.TopicChangedEvent
      | Traq.SubscribersChangedEvent
      | Traq.PinAddedEvent
      | Traq.PinRemovedEvent
      | Traq.NameChangedEvent
      | Traq.ParentChangedEvent
      | Traq.VisibilityChangedEvent
      | Traq.ForcedNotificationChangedEvent
      | Traq.ChildCreatedEvent;
  };
...
declare const api: {
  ...
  /** 自分のアイコン画像を取得 */
  getMyIcon(input?: { form?: Record<string, string | Blob> }): Promise<Blob>;
  ...
  ws(input?: { form?: Record<string, string | Blob> }): Promise<null>;
  ...
  connectBotWS(input?: { form?: Record<string, string | Blob> }): Promise<null>;
