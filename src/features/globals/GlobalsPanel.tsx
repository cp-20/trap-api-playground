...
import { entityIndexesAtom } from "../entities/state";
import { EMPTY_GLOBALS } from "../entities/types";
...
export const GlobalsPanel = () => {
  const globals = useAtomValue(entityIndexesAtom)?.globals ?? EMPTY_GLOBALS;

  return (
    <aside className={styles.globalsPanel} aria-label="読み込み済み Globals">
